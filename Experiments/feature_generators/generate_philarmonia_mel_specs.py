...
empty_subdirectories("philarmonia_mel_specs")
...
for index, row in tqdm(df.iterrows()):
    file_path = row["filename"].replace("E:", "D:")
    ...
    relative_file_path = row["filename"].split("\\")[-1].split(".")[0] + ".jpg"
    output_file = f'philarmonia_mel_specs//{row["label"]}//{relative_file_path}'
